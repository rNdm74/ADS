...
/// </summary>
template<class T> void LinkedListQueue<T>::Push( T item )
{
...
/// </summary>
template<class T> T LinkedListQueue<T>::Pop()
{
	if( head == nullptr )
	{
...
///					2. Exception thrown if stack empty
/// </summary>
template<class T> T LinkedListQueue<T>::Peek()
{
	if( head == nullptr )
	{
		// Throw exeption if stack empty
...
/// </summary>
template<class T> int LinkedListQueue<T>::Count()
{
...
/// </summary>
template<class T> bool LinkedListQueue<T>::IsEmpty()
{
	return head == nullptr;
};
...
/// POST-CONDITION: 
/// </summary>
template<class T> void LinkedListQueue<T>::Dump()
{
